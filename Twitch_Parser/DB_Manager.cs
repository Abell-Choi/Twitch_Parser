...
namespace Twitch_Parser {
    public class DB_Manager {
        ...
        public Dictionary<string, object> _insert_channel_info(
            ...
            if (B_TAGS == null || B_TAGS.Count == 0) { B_TAGS_string = "[]"; }
            else { B_TAGS_string = JsonConvert.SerializeObject(B_TAGS); }
            ...
            try {
                ...
                if (_res == 1) { return this._get_result_map("OK", "SNED_CONFIRM", "TRUE"); }
                else { return this._get_result_map("ERR", "SEND_ERROR", "SEND_ERR"); }
            } catch (Exception e) {
        ...
        public Dictionary<string, object> _update_channel_info(
            ...
            Func<string, string, dynamic, string> _update = (string B_LOGIN_PK, string column, dynamic _dt) => {
                ...
                else if (_data_string == string.Empty) { _data_string = _dt; }
            ...
            try {
                var _res = _cmd.ExecuteNonQuery();
                if (_res == 1) { return this._get_result_map("OK", "UPDATE_CONFIRM", "UPDATE_CONFIRM"); }
                else { return this._get_result_map("ERR", "UPDATE_ERROR", "UPDATE_ERR"); }
            } catch (Exception e) {
